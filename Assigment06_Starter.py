...
# Wparks,5.21.2023,Modified code to complete assignment 06
# Wparks, 5.24.2025,Added additional comments, cleaned up code
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def remove_data_from_list(task, list_of_rows):
        ...
        for i in list_of_rows:
            if i['Task'].lower() == task.lower():  # checking if values match user input while going through list
                list_of_rows.remove(i)  # if value matches it is removed here
        return list_of_rows
    ...
    def write_data_to_file(file_name, list_of_rows):
        ...
        for i in list_of_rows:
            file_obj.write(i["Task"] + ',' + i["Priority"] + '\n')  # writing list to file
        file_obj.close()
        return list_of_rows
...
class IO:
    ...
    def input_task_to_remove():
        ...
        """
        task_remove = input('Please enter the name of the task you\'d like to remove: ')  # getting input for task to
        # remove
        print(f'Removing {task_remove} from the list!')  # feedback to user
        return task_remove
